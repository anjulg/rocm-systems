...
class TestRunTier1AnalysisRefactor(unittest.TestCase):
    ...
    def test_returns_tuple(self):
        ...
        with patch("perfxpert.ai_analysis.api.analyze_database", return_value=mock_result):
    ...
    def test_returns_none_breakdown_on_exception(self):
        ...
        with patch(
            "perfxpert.ai_analysis.api.analyze_database", side_effect=RuntimeError("db error")
        ):
...
class TestContextUpdateMethods(unittest.TestCase):
    ...
    def _make_session_with_ctx(self):
        from perfxpert.ai_analysis.interactive import InteractiveSession, SessionContext
    ...
    def test_update_ctx_analysis_appends(self):
        from perfxpert.ai_analysis.interactive import InteractiveSession
...
class TestPersistence(unittest.TestCase):
    ...
    def test_old_session_file_without_context_key(self):
        ...
        from perfxpert.ai_analysis.interactive import SessionData, SessionContext
