...
extern hipError_t playback_hipExtLaunchKernel(PlaybackContext& ctx, const uint8_t* payload);
...
extern hipError_t playback_hipModuleLoadFatBinary(PlaybackContext& ctx, const uint8_t* payload);
