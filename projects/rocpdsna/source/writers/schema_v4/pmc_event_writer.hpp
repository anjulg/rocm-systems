...
/**
 * @brief PMC event writer for schema v4 (latest)
 *
 * PMC event structure is similar between v3 and v4
 */
template <>
class pmc_event_writer<data_storage::schema_v4_tag>
: public pmc_event_writer_interface<pmc_event_writer<data_storage::schema_v4_tag>>
{
public:
