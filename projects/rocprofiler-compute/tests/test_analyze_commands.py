...
def test_ast_transformer_edge_cases():
    ...
    from utils.metrics import CodeTransformer
...
def test_build_dfs_edge_cases():
    ...
    from utils.metrics import gen_counter_list
...
def test_update_functions_coverage():
    ...
    from utils.metrics import update_denominator_string, update_normal_unit_string
