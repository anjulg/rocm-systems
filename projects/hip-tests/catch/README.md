...
- ```HIP_SKIP_TEST``` : The api takes in an input of the reason as well and prints out the line HIP_SKIP_THIS_TEST. It uses the Catch2 SKIP macro to actually end the test execution and report the status as skipped. ctest also marks the test as skipped
